...
if __name__ == "__main__":
    input_file = "myProfile_.png"  # ไฟล์รูปภาพต้นฉบับ
    encrypted_file = "test_encrypted.bin"  # ไฟล์ที่ถูกเข้ารหัส
    decrypted_file = "test_decrypted.jpg"  # ไฟล์รูปที่ถอดรหัสกลับมา
